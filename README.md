...
| 分數範圍      | 判定標籤   | 解釋說明                                               |
|:-------------:|:---------:|:------------------------------------------------------|
| ≥ 0.85        | 極高相似   | 音色、節奏與聲學特徵幾乎完全一致，疑似重製或轉錄          |
| 0.70 – 0.85   | 高相似     | 大致相似，可能為改編、翻唱、不同語言版本                 |
| 0.50 – 0.70   | 中度相似   | 屬於同主題或相近風格，音軌有部分相似區段                 |
| 0.30 – 0.50   | 低度相似   | 僅有少數特徵吻合，可視為不同來源                        |
| < 0.30        | 無明顯關聯 | 聲音特徵差異明顯，判定為完全不同音源                     |
